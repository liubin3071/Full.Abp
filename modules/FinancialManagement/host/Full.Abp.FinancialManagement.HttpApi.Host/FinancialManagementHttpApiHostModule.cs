...
public class FinancialManagementHttpApiHostModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.AddAbpSwaggerGenWithOAuth(
            ...
            {
                {"FinancialManagement", "FinancialManagement API"}
            },
            options =>
            {
        ...
        {
            options.KeyPrefix = "FinancialManagement:";
        });

        var dataProtectionBuilder = context.Services.AddDataProtection().SetApplicationName("FinancialManagement");
        if (!hostingEnvironment.IsDevelopment())
        {
            var redis = ConnectionMultiplexer.Connect(configuration["Redis:Configuration"]);
            dataProtectionBuilder.PersistKeysToStackExchangeRedis(redis, "FinancialManagement-Protection-Keys");
        }
    ...
    public async override Task OnApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        ...
        app.UseAbpSwaggerUI(options =>
        {
            ...
            options.OAuthScopes("FinancialManagement");
        });
        app.UseAuditing();
