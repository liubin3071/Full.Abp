...
public class PaymentManagementWebHostMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public PaymentManagementWebHostMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<PaymentManagementResource>();
