...
public partial class CategoryManagement
{
    ...
    private IEnumerable<CategoryDto> _roots = new List<CategoryDto>();


    public async Task<IEnumerable<CategoryDto>> GetChildrenAsync(CategoryDto category)
    {
        return (await CategoryAppService.GetChildrenAsync(DefinitionName, category.Id)).Items;
    }
    ...
    public Form<CategoryCreateOrUpdateInput> EditFormRef { get; set; }
    public bool CreateModalVisible { get; set; }
    public Form<CategoryCreateOrUpdateInput> CreateFormRef { get; set; }
    ...
    protected virtual async Task GetEntitiesAsync()
    {
        try
        {
            ...
            var result = await CategoryAppService.GetChildrenAsync(DefinitionName, null);
    ...
    protected virtual async Task OpenEditModalAsync(CategoryDto entity)
    {
        try
        {
            ...
            var entityDto = await CategoryAppService.GetAsync(DefinitionName, entity.Id);
    ...
    protected virtual async Task CreateEntityAsync()
    {
        try
        {
            ...
            await CategoryAppService.CreateAsync(DefinitionName, createInput);
    ...
    protected virtual async Task UpdateEntityAsync()
    {
        try
        {
            ...
            if (validate)
            {
                ...
                await CategoryAppService.UpdateAsync(DefinitionName, EditingEntityId, updateInput);
    ...
    protected virtual async Task DeleteEntityAsync(CategoryDto entity)
    {
        try
        {
            ...
            await CategoryAppService.DeleteAsync(DefinitionName, entity.Id);
    ...
    {
        var result = await CategoryAppService.GetChildrenAsync(DefinitionName,category.Id);
        return result.Items;
    }
}