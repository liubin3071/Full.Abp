...
namespace Full.Abp.CategoryManagement.Blazor.Server.Host.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CategoryManagementCategoryTreeNodeRelations",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryManagementCategoryTreeNodeRelations", x => new { x.Ancestor, x.Descendant, x.TreeId });
                });

            migrationBuilder.CreateTable(
                name: "CategoryManagementCategoryTrees",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryManagementCategoryTrees", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryManagementCategoryTreeNodeRelations_Ancestor",
                table: "CategoryManagementCategoryTreeNodeRelations",
                column: "Ancestor");

            migrationBuilder.CreateIndex(
                name: "IX_CategoryManagementCategoryTreeNodeRelations_Descendant",
                table: "CategoryManagementCategoryTreeNodeRelations",
                column: "Descendant");

            migrationBuilder.CreateIndex(
                name: "IX_CategoryManagementCategoryTrees_ProviderType_ProviderName_ProviderKey",
                table: "CategoryManagementCategoryTrees",
                columns: new[] { "ProviderType", "ProviderName", "ProviderKey" },
                unique: true);
        }
