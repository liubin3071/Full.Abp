...
using Full.Abp.AspnetCore.Components.Server.AntDesignTheme.Bundling;
...
using Full.Abp.CategoryManagement.Blazor.Server.AntDesignUI;
...
using Full.Abp.IdentityManagement.Blazor.Server.AntDesignUI;
...
[DependsOn(
    ...
    typeof(CategoryManagementBlazorServerAntDesignUiModule),
        ...
        Configure<AbpBundlingOptions>(options =>
        {
                ...
                bundle =>
                {
                    bundle.AddFiles("/blazor-global-styles.css");
                        ...
                        bundle.AddFiles("/Full.Abp.CategoryManagement.Blazor.Server.AntDesignUI.Host.styles.css");
                }
            );
        });
